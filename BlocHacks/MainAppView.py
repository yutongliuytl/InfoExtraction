...
class MainAppView(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.t1 = tk.Entry(self, bg='white', width=30)
        ...
        self.t2 = tk.Entry(self, bg='lightgrey', width=30)
        ...
        self.t3 = tk.Entry(self, bg='white', width=30)
        ...
        self.t4 = tk.Entry(self, bg='lightgrey', width=30)
        ...
        self.t5 = tk.Entry(self, bg='white', width=30)
        ...
        self.t6 = tk.Entry(self, bg='lightgrey', width=30)
        ...
        self.t7 = tk.Entry(self, bg='white', width=30)
        ...
        self.t8 = tk.Entry(self, bg='lightgrey', width=30)
        ...
        self.t9 = tk.Entry(self, bg='white', width=30)
